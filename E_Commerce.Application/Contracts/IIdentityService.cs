...
namespace E_Commerce.Application.Contracts
{
    ...
    {
        Task<Result<IdentityUserResult>> FindUserByEmailAsync(string email, CancellationToken cancellationToken = default);
        ...
        Task<Result<IReadOnlyList<string>>> GetUserRolesAsync(string email, CancellationToken cancellationToken = default);
